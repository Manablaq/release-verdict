...
4. Register one policy and at least three publisher authorities with distinct source groups. Each publisher registration includes a validated Ed25519 public key and key identifier. Authority prefixes must point to immutable public fixture records.
